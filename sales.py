...
class salesClass:
    def __init__(self,root):
        ...
        # title
        lbl_title=Label(self.root,text="View Customer Bills",font=("goudy old style",30,"bold"),bg="#367588",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)

        lbl_invoice=Label(self.root,text="Invoice No.",font=("times new roman",15),bg="#E0FBE2").place(x=50,y=100)
        ...
        #btn_print=Button(self.root,text="Print",command=self.print_bill,font=("times new roman",15,"bold"),bg="red",fg="white",cursor="hand2").place(x=620,y=100,width=120,height=28)
        ...
        lbl_title2=Label(bill_Frame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="orange").pack(side=TOP,fill=X)
        ...
        #image
        self.bill_photo=Image.open("images/sales2.jpg")
...
#----------------------------
    ...
    def search(self):
        if self.var_invoice.get()=="":
            messagebox.showerror("Error","Invoice no should ne required",parent=self.root)
        else:
    ...
    #     else:
    #         messagebox.showerror("Print","Select bill to print",parent=self.root)
